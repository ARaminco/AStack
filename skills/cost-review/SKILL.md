...
## ماموریت
این skill برای ارزیابی حرفه‌ای حوزه‌ی بازبینی Cost استفاده می‌شود و باید خروجی قابل‌اقدام، دقیق و مناسب production تولید کند.

## چه زمانی استفاده شود
- وقتی تغییر، review یا برنامه‌ریزی به بازبینی Cost مربوط است.
