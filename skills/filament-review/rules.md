...
## معیار کیفیت
- بررسی `Resource authorization` و ثبت وضعیت pass، fail یا not applicable.
- بررسی `form schemas` و ثبت وضعیت pass، fail یا not applicable.
- بررسی `table performance` و ثبت وضعیت pass، fail یا not applicable.
- بررسی `bulk actions` و ثبت وضعیت pass، fail یا not applicable.
- بررسی `relation managers` و ثبت وضعیت pass، fail یا not applicable.
- بررسی `Livewire state` و ثبت وضعیت pass، fail یا not applicable.
- بررسی `admin UX` و ثبت وضعیت pass، fail یا not applicable.
