...
## معیار کیفیت
- بررسی `unit tests` و ثبت وضعیت pass، fail یا not applicable.
- بررسی `feature tests` و ثبت وضعیت pass، fail یا not applicable.
- بررسی `integration tests` و ثبت وضعیت pass، fail یا not applicable.
- بررسی `browser tests` و ثبت وضعیت pass، fail یا not applicable.
- بررسی `API tests` و ثبت وضعیت pass، fail یا not applicable.
- بررسی `Pest` و ثبت وضعیت pass، fail یا not applicable.
- بررسی `test data` و ثبت وضعیت pass، fail یا not applicable.
