...
- Architecture: layered, plugin-ready, provider-agnostic, domain-aware
...
## Engagement Domains
The domain registry (`domains/domains.json`) routes every request — in Persian or English — to the right departments, workflow, and team blueprint: software, legal, finance, accounting, tax, marketing, operations, hr, research, business.
